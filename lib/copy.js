...
export const copy = {
  metadata: {
    ...
    description:
      "1000 Zdrowych Przepisów 2.0 dla diabetyków: pyszne, proste i stworzone specjalnie, by trzymać cukier w ryzach. Oferta specjalna: 30 zł + 5 darmowych bonusów.",
    lang: "pl",
  },
    ...
    forYouItems: [
      {
        ...
        desc: "Odkryjesz tu przepisy stworzone po to, by trzymać cukier w ryzach, bez odmawiania sobie przyjemności z jedzenia.",
      },
      {
        icon: "Sparkles",
    ...
    items: [
      {
        ...
        tag: "BONUS 1",
        title: "E-book: 100 Zdrowych Zup",
        desc: "100 rozgrzewających przepisów na zupy o niskiej zawartości węglowodanów i szkodliwych cukrów.",
        value: "60 zł",
      },
      {
        image: "/bonuses/batidos.webp",
        tag: "BONUS 2",
        title: "E-book: 67 Zdrowych Koktajli",
        desc: "67 orzeźwiających i super-odżywczych smoothie, całkowicie bezpiecznych dla Twojej glikemii.",
        value: "60 zł",
      },
      {
        image: "/bonuses/snacks.webp",
        tag: "BONUS 3",
        title: "E-book: 100 Zdrowych Przekąsek",
        desc: "100 pomysłów na coś na ząb – robisz szybko, jesz ze smakiem i dbasz o organizm.",
        value: "60 zł",
      },
      {
  ...
  finalCta: {
    ...
    bundleList: [
      ...
      "Bonus 1 — 100 Zdrowych Zup",
      "Bonus 2 — 67 Zdrowych Koktajli",
      "Bonus 3 — 100 Zdrowych Przekąsek",
    ...
    urgencyText: "PŁATNOŚĆ JEST W 100% BEZPIECZNA",
