...
export const copy = {
  metadata: {
    title: "Esencia Pro | 1000 Zdrowych Przepisów 2.0",
    description:
  ...
  faq: {
    authorRole: "Esencia Pro · Zespół ds. zdrowego odżywiania",
    authorHeadline: "Pyszne jedzenie, które realnie dba o Twoje zdrowie",
    authorBio:
      "W Esencia Pro mocno wierzymy, że cukrzyca wcale nie musi odbierać Ci radości z posiłków. Każdy z naszych przepisów powstał po to, byś mógł cieszyć się smakiem bez jakichkolwiek wyrzutów sumienia, mając swoją glikemię pod pełną kontrolą.",
    authorImageAlt: "Zespół ekspertów Esencia Pro",
